...
import parking_spot_detection.utils
...
def _download_raw_dataset(metadata: Dict[str, str], dl_path: Path) -> Path:
    ...
    parking_spot_detection.utils.download_url(metadata["url"], filename)
    print("Computing SHA256.")
    sha256 = parking_spot_detection.utils.compute_sha256(filename)
