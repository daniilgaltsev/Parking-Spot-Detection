"""CIFAR-10 data module that downloads and saves data as .h5 files if not already present."""
...
from parking_spot_detection.data.base_data_module import BaseDataModule
from parking_spot_detection.data.base_dataset import BaseDataset
from parking_spot_detection.data.utils import _download_raw_dataset
...
class CIFAR10(BaseDataModule):
    ...
    def __init__(self, args: Optional[argparse.Namespace] = None):
        ...
        transforms_list = [
            transforms.ToTensor(),
            # Calculated using parking_spot_detection.data.utils.calculate_mean_and_std
...
def _process_raw_dataset(filename: str, dirname: Path) -> None:
    ...
    print('Saving essential dataset parameters to parking_spot_detection/data')
